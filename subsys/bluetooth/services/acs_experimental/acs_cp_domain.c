...
enum acs_cp_response_code {
	...
	ACS_CP_RESPONSE_OPCODE_NOT_SUPPORTED = 0x02,
	ACS_CP_RESPONSE_INVALID_OPERAND = 0x03,
	ACS_CP_RESPONSE_PROCEDURE_NOT_COMPLETED = 0x04,
	ACS_CP_RESPONSE_PARAMETER_OUT_OF_RANGE = 0x05,
	ACS_CP_RESPONSE_PROCEDURE_NOT_APPLICABLE = 0x06,
...
enum acs_key_exchange_result_code {
	ACS_KEY_EXCHANGE_RESULT_SUCCESSFUL = 0x00,
	ACS_KEY_EXCHANGE_RESULT_FAILED = 0x01,
};

enum acs_rmap_record_type {
	ACS_RMAP_RECORD_RESTRICTION_MAP_ID = 0x00,
	ACS_RMAP_RECORD_DEFAULT_ISC = 0x01,
...
enum acs_isc_control_type {
	...
	ACS_ISC_CTRL_AUTHENTICATED = 0x01,
	ACS_ISC_CTRL_ENCRYPTED = 0x02,
	ACS_ISC_CTRL_AUTHENTICATED_ENCRYPTED = 0x03,
	ACS_ISC_CTRL_AUTHENTICATED_ENCRYPTED_AD = 0x04,
	ACS_ISC_CTRL_UNENCRYPTED = 0x05,
	ACS_ISC_CTRL_MAC = 0x06,
};

enum acs_key_record_type {
	ACS_KEY_REC_OOB = 0x00,
	ACS_KEY_REC_ECDH = 0x01,
	ACS_KEY_REC_KDF = 0x02,
	ACS_KEY_REC_AES_CMAC = 0x03,
	ACS_KEY_REC_AES_CCM = 0x04,
	ACS_KEY_REC_AES_EAX = 0x05,
	ACS_KEY_REC_AES_GCM = 0x06,
	ACS_KEY_REC_AES_GMAC = 0x07,
};

enum acs_key_format {
	ACS_KEY_FMT_PLAIN = 0x00,
	ACS_KEY_FMT_X509 = 0x01,
};
...
enum acs_message_type {
	ACS_MSG_PROFILE_DEFINED = 0x00,
	ACS_MSG_PROTECTED_RESOURCE = 0x01,
};

enum acs_nonce_type {
	ACS_NONCE_SEQ_EVEN_ODD = 0x01,
	ACS_NONCE_SEQ_DIFF_FIXED = 0x02,
};

enum {
	ACS_KEY_ID_ECDH = 0x0001,
	ACS_KEY_ID_KDF = 0x0002,
	ACS_KEY_ID_AES_CMAC = 0x0003,
	ACS_KEY_ID_AES_CCM = 0x0004,
	ACS_KEY_ID_AES_EAX = 0x0005,
	ACS_KEY_ID_AES_GCM = 0x0006,
	ACS_KEY_ID_AES_GMAC = 0x0007,
};

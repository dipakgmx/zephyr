...
#define TMC50XX_VSTART(motor)    ((uint8_t)(0x03 | TMC50XX_MOTOR_ADDR(motor)))
#define TMC50XX_A1(motor)        ((uint8_t)(0x04 | TMC50XX_MOTOR_ADDR(motor)))
#define TMC50XX_V1(motor)        ((uint8_t)(0x05 | TMC50XX_MOTOR_ADDR(motor)))
#define TMC50XX_AMAX(motor)      ((uint8_t)(0x06 | TMC50XX_MOTOR_ADDR(motor)))
#define TMC5XXX_VMAX(motor)      ((uint8_t)(0x07 | TMC50XX_MOTOR_ADDR(motor)))
#define TMC50XX_DMAX(motor)      ((uint8_t)(0x08 | TMC50XX_MOTOR_ADDR(motor)))
#define TMC50XX_D1(motor)        ((uint8_t)(0x0A | TMC50XX_MOTOR_ADDR(motor)))
#define TMC50XX_VSTOP(motor)     ((uint8_t)(0x0B | TMC50XX_MOTOR_ADDR(motor)))
#define TMC50XX_TZEROWAIT(motor) ((uint8_t)(0x0C | TMC50XX_MOTOR_ADDR(motor)))
